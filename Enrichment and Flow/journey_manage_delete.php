...
if (isActionAccessible($guid, $connection2, '/modules/Enrichment and Flow/journey_manage_delete.php') == false || $highestAction == false) {
    ...
    $form = DeleteForm::createForm($session->get('absoluteURL')."/modules/Enrichment and Flow/journey_manage_deleteProcess.php?search=$search&status=$status&gibbonPersonIDStudent=$gibbonPersonIDStudent");
    echo $form->getOutput();
}
