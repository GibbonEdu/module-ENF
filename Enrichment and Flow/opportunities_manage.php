...
if (isActionAccessible($guid, $connection2, '/modules/Enrichment and Flow/opportunities_manage.php') == false) {
    // Access denied
    ...
    $table->addHeaderAction('add', __('Add'))
        ...
        ->setURL('/modules/Enrichment and Flow/opportunities_manage_add.php')
        ->displayLabel();
    ...
    $table->addActionColumn()
        ->addParam('enfOpportunityID')
        ->addParam('search', $search)
        ->format(function ($category, $actions) {
            $actions->addAction('edit', __('Edit'))
                    ->setURL('/modules/Enrichment and Flow/opportunities_manage_edit.php');

            $actions->addAction('delete', __('Delete'))
                    ->setURL('/modules/Enrichment and Flow/opportunities_manage_delete.php');
        });
