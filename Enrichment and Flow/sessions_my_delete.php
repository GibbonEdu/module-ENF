...
if (isActionAccessible($guid, $connection2, '/modules/Enrichment and Flow/sessions_my_delete.php') == false) {
    ...
    // Proceed!
    $enfPlannedSessionID = $_GET['enfPlannedSessionID'] ?? '';
    ...
    $form = DeleteForm::createForm($session->get('absoluteURL').'/modules/Enrichment and Flow/sessions_my_deleteProcess.php');
    echo $form->getOutput();
}
